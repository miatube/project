function postComment(button, postedBy, videoId, replyTo, containerClass) {
    ...
    if(commentText) {
        ...
        $.post("assets/ajax/postComment.php", { commentText: commentText, postedBy: postedBy, 
...
function likeComment(commentId, button, videoId) {
    $.post("assets/ajax/likeComment.php", { commentId: commentId, videoId: videoId })
...
function dislikeComment(commentId, button, videoId) {
    $.post("assets/ajax/dislikeComment.php", { commentId: commentId, videoId: videoId })
    .done(function(numToChange) {
...
function getReplies(commentId, button, videoId) {
    $.post("assets/ajax/getCommentReplies.php", { commentId: commentId, videoId: videoId })
